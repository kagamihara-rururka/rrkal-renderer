...
def _to_html(
    ...
    html_lines: List[str] = [
        ...
        "      <p class='hotkeys small'>Shortcuts: J/K or [] or ←/→ (page prev/next), ↑/↓ (row nav), Shift+Enter (copy first row on current page), Shift+Alt+Enter (copy last row on current page), Home/End (jump first/last row), C/Enter (copy selected), F/T (focus symbol filters), R (reset active), 0 (clear filters)</p>",
        "    </section>",
        "    <section class='panel'>",
