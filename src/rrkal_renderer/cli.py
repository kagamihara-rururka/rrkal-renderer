...
def _to_html(
    ...
    html_lines.extend([
        ...
        "          `<span class='card-sub'>${highlightText(symbolText, searchTerm)} · ${highlightText(tsText, searchTerm)}</span>` +",
        ...
        "          `<span class='card-sub'>pnl ${highlightText(pnlText, searchTerm)} · qty ${highlightText(qtyText, searchTerm)}</span>` +",
