...
def _to_html(
    ...
    html_lines.extend([
        ...
        "      </div>",
        "      <p class='note'>Shortcuts: / to focus search, Enter/C to copy selection, F/T to jump symbol input, P to toggle Photo Layout.</p>",
        "    </section>",
        "    <section class='panel'>",
        ...
        f"        layoutSubtitle.textContent = `RRKAL 2.0.0 photo-style pre-renderer mode=${{modeText}} | html rows: {inspect_cap_label}`;",
        "      }",
