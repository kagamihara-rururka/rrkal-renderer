...
def _to_html(
    ...
    html_lines: List[str] = [
        ...
        "      <p class='hotkeys small'>Shortcuts: J/K (table page), ↑/↓ (row nav), [] or ←/→ (page prev/next), C (copy selected), F/T (focus symbol filters), R (reset active), 0 (clear filters), Enter (copy selected row)</p>",
        "    </section>",
        "    <section class='panel'>",
